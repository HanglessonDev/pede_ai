...
class TestGetItemPorId:
    ...
    @pytest.mark.parametrize('item_id,expected_nome', [
...
class TestGetPrecoItem:
    ...
    @pytest.mark.parametrize('item_id,expected_preco', [
        ('lanche_002', 1800),
        ('lanche_003', 2000),
    ])
...
class TestGetVariantes:
    ...
    @pytest.mark.parametrize('item_id,expected_count,expected_items', [
...
class TestGetItensPorCategoria:
    ...
    @pytest.mark.parametrize('categoria,min_itens', [
        ('lanche', 1),
        ('bebida', 1),
        ('acompanhamento', 1),
    ])
    ...
    def test_todos_itens_tem_campos_obrigatorios(self):
        ...
        for item in cardapio['itens']:
            for campo in obrigatorios:
                assert campo in item, f"Campo '{campo}' ausente no item {item.get('id')}"
